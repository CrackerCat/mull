...
; WITHOUT-OPTION-NEXT:{{^.*}}sample.cpp:38:19: warning: Survived: Replaced + with -{{$}}
...
; WITH-OPTION-NEXT:{{^.*}}sample.cpp:37:18: warning: Killed: Replaced + with -
; WITH-OPTION-NEXT:  int result = a + b;
; WITH-OPTION-NEXT:                 ^
; WITH-OPTION-NEXT:[info] Survived mutants (1/2):
; WITH-OPTION-NEXT:{{^.*}}sample.cpp:38:19: warning: Survived: Replaced + with -
